 ...
 * @param mesh_tri Output vector that will be resized to contain triangle indices. 
 *                 The format is [v0, v1, v2, v0, v1, v2, ...] for each triangle.
 * @param mesh_ver Output vector that will be resized to contain vertex coordinates. 
 ...
 */
void determine_facet_adjacency(std::vector<Facet>& all_facets, const std::unordered_map<int, int>& amd);
